...
public class WeatherToTextConverter {
    ...
    private static void putCodesMeanings(HashMap<Integer, String> codes){
        ...
        codes.put(502, "It is heavily fucking raining intensely outside");
        ...
        codes.put(800, "It is fucking clear outside");
        ...
        codes.put(956, "It is strongly fucking breezy outside");
        codes.put(957, "There are fucking high winds, near gale outside");
