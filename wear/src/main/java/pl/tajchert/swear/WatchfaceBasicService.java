 ...
 */
public class WatchfaceBasicService extends CanvasWatchFaceService {
    private static final String TAG = "WatchfaceBasicService";
    ...
    private class Engine extends CanvasWatchFaceService.Engine implements DataApi.DataListener,
        ...
        GoogleApiClient mGoogleApiClient = new GoogleApiClient.Builder(WatchfaceBasicService.this)
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            setWatchFaceStyle(new WatchFaceStyle.Builder(WatchfaceBasicService.this)
                    .setCardPeekMode(WatchFaceStyle.PEEK_MODE_VARIABLE)
                    .setBackgroundVisibility(WatchFaceStyle.BACKGROUND_VISIBILITY_INTERRUPTIVE)
                    .setShowSystemUiTime(false)
                    .build());
            Resources resources = WatchfaceBasicService.this.getResources();
        ...
        private void registerReceiver() {
            ...
            WatchfaceBasicService.this.registerReceiver(mTimeZoneReceiver, filter);
        }
        ...
        private void unregisterReceiver() {
            ...
            WatchfaceBasicService.this.unregisterReceiver(mTimeZoneReceiver);
        }
